...
class Ui_SpottingExp(QMainWindow):
    ...
    def setupUi(self, SpottingExp):
        ...
        self.pushButton_PENUP.setGeometry(QtCore.QRect(250, 90, 81, 31))
        ...
        self.pushButton_PENDOWN.setGeometry(QtCore.QRect(250, 50, 81, 31))
        ...
        self.spinBox_goPosx.setGeometry(QtCore.QRect(spinBoxpos1, 300, 47, 31))
        ...
        self.spinBox_goPosy.setGeometry(QtCore.QRect(spinBoxpos2, 300, 47, 31))
        ...
        self.spinBox_ppd.setGeometry(QtCore.QRect(spinBoxpos1, 50, 47, 31))
        ...
        self.spinBox_ppu.setGeometry(QtCore.QRect(spinBoxpos1, 90, 47, 31))
        ...
        self.spinBox_dipPosx1.setGeometry(QtCore.QRect(spinBoxpos3, 220, 47, 31))
        ...
        self.spinBox_dipPosx2.setGeometry(QtCore.QRect(spinBoxpos3, 260, 47, 31))
        ...
        self.spinBox_dipPosx3.setGeometry(QtCore.QRect(spinBoxpos3, 300, 47, 31))
        ...
        self.spinBox_dipPosy1.setGeometry(QtCore.QRect(spinBoxpos4, 220, 47, 31))
        ...
        self.spinBox_dipPosy2.setGeometry(QtCore.QRect(spinBoxpos4, 260, 47, 31))
        ...
        self.spinBox_dipPosy3.setGeometry(QtCore.QRect(spinBoxpos4, 300, 47, 31))
    ...
    def DipSample(self):
        ...
        self.ad.options.pen_pos_up = self.ppu
        self.ad.options.pen_pos_down = 10
        self.ad.update()
        if self.connection == False:
            msg = QMessageBox()
            msg.setWindowTitle("Connection Status")
